    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbar-menu">
            <ul class="navbar-nav pt-lg-3">
                ...
                @can('index-vehicle')
                <li class="nav-item">
                    <a class="nav-link {{ Route::is('admin.vehicle*') ? 'active' : '' }}" href="{{ route('admin.vehicle.index') }}">
                ...
                {{-- STOK & LAPORAN --}}
                <div class="hr-text hr-text-left ml-2 mb-2 mt-2">Stok & Laporan</div>
                <li class="nav-item">
                ...
                <div class="hr-text hr-text-left ml-2 mb-2 mt-2">Transaksi</div>
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('admin.manual.transaction') }}">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ Route::is('admin.transaction.product') ? 'active' : '' }}" href="{{ route('admin.transaction.product') }}">
                        <i class="fas fa-arrow-circle-up mr-2"></i>
                        <span>Barang Keluar</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ Route::is('admin.transaction.vehicle') ? 'active' : '' }}" href="{{ route('admin.transaction.vehicle') }}">
